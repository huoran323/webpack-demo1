...
module.exports = {
    mode: "production", //模式 development:bundle.js不会被压缩  production: bundle.js会被压缩
    // entry: "./src/index.js", //从index.js开始打包

    devtool: 'cheap-module-source-map', //sourceMap是一个映射关系，他可以知道打包文件中的js对应src下面的哪个js,可以映射到代码所在的src文件的位置,可以映射到源代码哪行出错了
    /* devtool:
